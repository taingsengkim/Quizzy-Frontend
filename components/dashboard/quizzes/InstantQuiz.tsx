...
export default function InstantQuizComponent() {
  ...
  if (loadingData) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-white dark:bg-[#05080f] gap-4">
    ...
    return (
      <div
        className="flex items-center justify-center min-h-screen px-6 
                  bg-gray-100 dark:bg-[#05080f] relative overflow-hidden"
      >
        <div className="hidden dark:block absolute inset-0">
          <div className="absolute top-[-120px] left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-sky-500/10 blur-3xl rounded-full" />
          <div className="absolute bottom-[-100px] right-[-80px] w-[400px] h-[250px] bg-violet-500/10 blur-3xl rounded-full" />
        </div>
        ...
        >
          ...
          <h2
            className="text-3xl font-black 
                     ...
                     uppercase italic tracking-tighter mb-2"
          >
            Instant <span className="text-sky-500 dark:text-sky-400">Quiz</span>
          </h2>

          <p
            className="text-gray-500 dark:text-slate-400 
                    font-mono text-xs uppercase tracking-widest mb-8"
          >
              ...
              {difficulties.map((d) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-start p-3 rounded-md border 
                  transition-all duration-200 
                  ${
                    isActive
                      ? d.active
                      : "border-gray-200 bg-gray-50 text-gray-700 hover:border-gray-400 " +
                        "dark:border-slate-700 dark:bg-[#0b1020] dark:text-slate-300 dark:hover:border-slate-500"
                  }`}
                  >
          ...
          <Button
            ...
            className="w-full h-12 
                   ...
                   rounded-md shadow-lg shadow-sky-500/20 
...
dark:bg-[#05080f] dark:text-white"
      >
        <div className="max-w-4xl w-full animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="text-center mb-16 relative">
            ...
            <Trophy className="w-16 h-16 text-emerald-500 dark:text-emerald-400 mx-auto mb-6" />
      ...
      text-gray-500 dark:text-slate-400"
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-20">
            <div
              className="p-8 rounded-xl min-w-[180px] text-center shadow-2xl
      ...
      dark:bg-[#0d121f] dark:border-sky-500/20 dark:shadow-sky-500/5"
        ...
        text-gray-900 dark:text-white"
            ...
            <div
              className="p-8 rounded-xl min-w-[180px] text-center shadow-2xl
      bg-white border border-gray-200
      dark:bg-[#0d121f] dark:border-violet-500/20 dark:shadow-violet-500/5"
            >
              <p
                className="text-[10px] font-mono uppercase tracking-widest mb-2
        text-gray-500 dark:text-slate-400"
      ...
      text-gray-500 dark:text-slate-400"
            ...
            {quiz.map((q, idx) => {
              ...
              return (
                <div
                  key={q.id}
                  className="p-8 rounded-xl backdrop-blur-md transition-colors
              ...
              text-gray-900 dark:text-white"
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {q.answers.map((ans) => {
                      ...
                      let cls =
                        "bg-gray-100 border-gray-300 text-gray-500 italic dark:bg-slate-900 dark:border-slate-800 dark:text-slate-500";
                      ...
                      if (ans.correct && userPicked)
                        ...
                        cls =
                          "bg-green-50 border-green-200 text-green-700 dark:bg-emerald-500/5 dark:border-emerald-500/20 dark:text-emerald-600";
                      else if (!ans.correct && userPicked)
                        cls =
                          "bg-red-100 border-red-300 text-red-600 dark:bg-rose-500/10 dark:border-rose-500/40 dark:text-rose-400";
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-3 h-16 rounded-xl font-black uppercase tracking-widest transition-all active:scale-95
        bg-sky-600 hover:bg-sky-500 text-white"
            ...
            <Link
              href="/quizzes"
              className="flex-1 flex items-center justify-center gap-3 h-16 rounded-xl font-black uppercase tracking-widest transition-all
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#05080f] flex items-center justify-center pt-20 px-6">
      ...
      >
        ...
        <div className="relative bg-gray-50 dark:bg-[#0d121f] border border-gray-200 dark:border-slate-800 p-5 md:p-8 rounded-xl shadow-2xl">
              ...
              {question.difficulty && (
                <div
                  className={`flex items-center gap-1 px-2.5 py-1 rounded-md border text-[10px] font-bold uppercase tracking-wider ${
                    ...
                    "text-slate-500 dark:text-slate-400 border-slate-400/20 bg-slate-400/5"
                  }`}
                >
                  {question.difficulty}
                </div>
        ...
        <div className="w-full my-5 space-y-2">
          <div className="flex justify-between font-mono text-[10px] text-gray-500 dark:text-slate-400 uppercase tracking-widest">
          ...
          <div className="flex flex-col gap-2">
            {question.hint && question.hint.trim() !== "" && (
              <>
                ...
                {showHint && (
                  <div className="p-4 rounded-md border border-amber-500/30 bg-amber-500/10 text-amber-700 dark:text-amber-300 text-sm max-w-xs">
                    💡 {question.hint}
                  </div>
                )}
              </>
