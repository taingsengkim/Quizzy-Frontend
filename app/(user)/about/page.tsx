  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`absolute inset-0 rounded-3xl blur-xl ${accent.glow} 
                shadow-2xl pointer-events-none`}
      />
      <div
        className="relative 
                  bg-white dark:bg-[#0d1220] 
                  border border-gray-200 dark:border-slate-800 
                  rounded-3xl p-8 overflow-hidden 
                  transition-colors duration-300 
                  group-hover:border-gray-300 dark:group-hover:border-slate-700"
      >
        <div
        ...
        <div
          className="absolute top-0 right-0 w-20 h-20 
                    ...
                    rounded-tr-3xl 
                    group-hover:border-gray-300 dark:group-hover:border-slate-600 
                    transition-colors"
        />
        <div
        ...
        >
          <motion.div
            ...
            className={`absolute inset-0 rounded-full ring-2 ${accent.ring} 
                    ring-offset-4 
                    ring-offset-white dark:ring-offset-[#0d1220]`}
            style={{
          ...
          <span
            className={`absolute bottom-1 right-1 w-4 h-4 
                    ...
                    border-white dark:border-[#0d1220]`}
          />
        </div>
...
export default function AboutPage() {
  return (
    <div className="min-h-screen mt-10 text-white">
      ...
      >
        <div
          className="absolute top-0 left-1/4 w-96 h-96 
                  bg-sky-500/10 dark:bg-sky-600/10 
            ...
            <div className="relative w-72 sm:w-80 lg:w-96 aspect-square">
              ...
              <div
                className="relative w-full h-full rounded-full overflow-hidden 
                        shadow-2xl ring-4 ring-sky-500/20"
              >
                <Image
                  src="/Student.png"
                  alt="Happy Student"
                ...
                return (
                  <motion.div
                    ...
                    className={`${positions[i]} 
                          bg-white dark:bg-[#0d1220] 
                          border border-gray-200 dark:border-slate-800 
                          rounded-2xl p-4 flex items-center gap-3 z-20`}
                  >
                    <div
      ...
      <section
        className="py-20 border-t border-gray-200 dark:border-slate-800/50 
          ...
          >
            ...
            <div
              className="absolute inset-0 
                      bg-gradient-to-t 
                      from-white/30 dark:from-[#080b14]/20 
                      to-transparent"
            />
          </motion.div>
          <motion.div
      ...
      >
        <div
          className="absolute inset-0 
                  bg-gradient-to-b 
                  from-transparent via-sky-100/40 dark:via-sky-950/10 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            className="lg:grid grid-cols-1 sm:flex sm:flex-wrap sm:justify-center lg:grid-cols-3 gap-6"
          >
            {teachers.map((t, i) => (
          ...
          <Link href="/">
            <motion.button
              ...
              className="bg-gradient-to-r from-sky-500 to-violet-500 
                   ...
                   rounded-2xl text-sm shadow-lg shadow-sky-500/20 
                   transition-all"
            >
